...
(define (test)
  ...
  (define s (merge-weighted (pairs integers integers) (pairs integers integers) proc))
  ...
  (define s2 (stream-filter not-divisible? (merge-weighted (pairs integers integers) (pairs integers integers) proc2)))
