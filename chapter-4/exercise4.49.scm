...
(define (parse-word word-list)
  ...
  (let ((found-word (list-ref (cdr word-list) (random-integer (length (cdr word-list))))))
    (set! *unparsed* (cdr *unparsed*))
    (list (car word-list) found-word)))

; a cat eats in a cat to the class
; a cat eats in a cat with a professor
; a red student lectures by the professor
; the student lectures nor a student lectures
; a red professor lectures with the class with a orange class
; the student studies steadily
; a orange student studies in the student nor a class lectures steadily with the professor
; the class studies steadily with a professor
; the student sleeps steadily by a cat in the class
; the green cat sleeps for a green class
