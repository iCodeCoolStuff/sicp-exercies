...
(define (mul-interval2 x y)
  (cond ((and (positive? (lower-bound x)) (positive? (lower-bound y)))
	...
	((and (negative? (upper-bound x)) (positive? (upper-bound y)))
	      (make-interval (* (upper-bound x) (upper-bound y))
			     (* (lower-bound x) (lower-bound y))))
	((and (positive? (upper-bound x)) (negative? (upper-bound y)))
	      (make-interval (* (upper-bound x) (lower-bound y))
			     (* (lower-bound x) (lower-bound y))))
...
(define (test)
  (display (mul-interval2 (make-interval 1 2)   (make-interval 3 4)))(newline)
  (display (mul-interval2 (make-interval -1 2)  (make-interval 3 4)))(newline)
  (display (mul-interval2 (make-interval 1 2)  (make-interval -3 4)))(newline)
  (display (mul-interval2 (make-interval -2 -1) (make-interval 3 4)))(newline)
  (display (mul-interval2 (make-interval -2 1) (make-interval -4 3)))(newline)
  (display (mul-interval2 (make-interval 1 2) (make-interval -4 -3)))(newline)
  (display (mul-interval2 (make-interval -2 -1) (make-interval -4 3)))(newline)
  (display (mul-interval2 (make-interval -2 1) (make-interval -4 -3)))(newline)
  (display (mul-interval2 (make-interval -2 -1) (make-interval -4 -3))))
...
;(1, 2) (-4, -3)
;(-1, 2) (-4, -3)   pos up  x and neg low y
